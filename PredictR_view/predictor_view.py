...
class Ui_RoweTechPredictor(object):
    def setupUi(self, RoweTechPredictor):
        ...
        RoweTechPredictor.resize(1590, 1030)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1566, 1006))
        ...
        self.horizontalLayout_2.addWidget(self.numBatteriesLabel)
        ...
        self.horizontalLayout_2.addWidget(self.batteryProgressBar)
        ...
        self.horizontalLayout_2.addWidget(self.dataUsageLabel)
