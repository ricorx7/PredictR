...
class Ui_RoweTechPredictor(object):
    def setupUi(self, RoweTechPredictor):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 30, 273, 191))
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.cerecordCheckBox)
        ...
        self.gridLayout_3.addWidget(self.subsystemConfigGroupBox, 1, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.predictionGroupBox, 2, 0, 1, 1)
        ...
        self.saveCommandsButton.setGeometry(QtCore.QRect(10, 300, 113, 32))
        self.saveCommandsButton.setObjectName("saveCommandsButton")
        self.gridLayout_3.addWidget(self.commandFileGroupBox, 3, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.revLabel, 4, 0, 1, 1)
